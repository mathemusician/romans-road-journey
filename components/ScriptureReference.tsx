    ...
    <>
      ...
      {!isMobile && isOpen && (
        <>
          ...
          <div
            ref={popoverRef}
            className="fixed z-50 w-[90vw] max-w-md max-h-[85vh] overflow-y-auto bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700"
            style={{
              top: '2rem',
              right: '2rem',
